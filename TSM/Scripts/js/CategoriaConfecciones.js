...
$(document).ready(function () {
    var dataSource = new kendo.data.DataSource({
        ...
        transport: {
            ...
            update: {
                url: function (datos) { return crudServiceBaseUrl + "/" + datos.IdCategoriaConfeccion; },
                dataType: "json",
                type: "PUT",
                contentType: "application/json; charset=utf-8"
            },
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            { field: "IdCategoriaConfeccion", title: "Código Confección", editor: Grid_ColInt64NumSinDecimal, hidden:true },
