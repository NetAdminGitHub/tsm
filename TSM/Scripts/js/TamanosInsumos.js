...
$(document).ready(function () {
    var dataSource = new kendo.data.DataSource({
        ...
        transport: {
            ...
            update: {
                url: function (datos) { return crudServiceBaseUrl + "/" + datos.IdTamanoInsumo; },
                dataType: "json",
                type: "PUT",
                contentType: "application/json; charset=utf-8"
            },
    ...
    $("#grid").kendoGrid({
        edit: function (e) {
            e.container.find("label[for=IdTamanoInsumo]").parent("div .k-form-field").hide();
            e.container.find("label[for=IdTamanoInsumo]").parent().next("div .k-edit-field").hide();
        ...
        columns: [
            { field: "IdTamanoInsumo", title: "Código Tamano Tipo", hidden: true },
            ...
            { field: "Nombre1", title: "Unidad Dimensión"},
        ]
    });
