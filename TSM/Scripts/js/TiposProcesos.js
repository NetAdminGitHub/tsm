var Permisos;
let UrlPl = TSM_Web_APi + "TiposProcesos";
...
$(document).ready(function () {
    let dataSource = new kendo.data.DataSource({
        ...
        transport: {
            ...
            update: {
                url: function (datos) { return UrlPl + "/" + datos.IdTipoProceso; },
                type: "PUT",
                contentType: "application/json; charset=utf-8"
            },
            destroy: {
    ...
    $("#grid").kendoGrid({
        edit: function (e) {
            KdoHideCampoPopup(e.container, "IdTipoProceso");
        ...
        columns: [
            { field: "IdTipoProceso", title: "Id", hidden: true },
