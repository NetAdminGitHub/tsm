...
function layoutsColors() {
    $(".sidebar").is("[data-background-color]") ? $("html").addClass("sidebar-color") : $("html").removeClass("sidebar-color"),
        $(".sidebar").is("[data-image]") ? ($(".sidebar").append("<div class='sidebar-background'></div>"),
            $(".sidebar-background").css("background-image", 'url("' + $(".sidebar").attr("data-image") + '")')) : ($(this).remove(".sidebar-background"),
                $(".sidebar-background").css("background-image", ""))
}
function legendClickCallback(e) {
    for (var a = (e = e || window.event).target || e.srcElement; "LI" !== a.nodeName;)
        a = a.parentElement;
    var s = a.parentElement
        , i = parseInt(s.classList[0].split("-")[0], 10)
        , o = Chart.instances[i]
        , n = Array.prototype.slice.call(s.children).indexOf(a);
    o.legend.options.onClick.call(o, e, o.legend.legendItems[n]),
        o.isDatasetVisible(n) ? a.classList.remove("hidden") : a.classList.add("hidden")
}
function readURL(e) {
...
$(".nav-search .input-group > input").focus(function (e) {
    ...
    $(document).ready(function () {
        ...
        var r, l = !1, t = !1, c = !1, d = !1, g = 0, m = 0, u = 0, h = 0, p = 0;
        l || ((r = $(".sidenav-toggler")).on("click", function () {
            1 == g ? ($("html").removeClass("nav_open"),
                r.removeClass("toggled"),
                g = 0) : ($("html").addClass("nav_open"),
                    r.addClass("toggled"),
                    g = 1)
        }),
            l = !0);
        m || ((r = $(".quick-sidebar-toggler")).on("click", function () {
            1 == g ? ($("html").removeClass("quick_sidebar_open"),
                $(".quick-sidebar-overlay").remove(),
                r.removeClass("toggled"),
                m = 0) : ($("html").addClass("quick_sidebar_open"),
                    r.addClass("toggled"),
            ...
            $(".wrapper").mouseup(function (e) {
                var a = $(".quick-sidebar");
                e.target.className == a.attr("class") || a.has(e.target).length || ($("html").removeClass("quick_sidebar_open"),
        ...
        if (!t) {
            ...
            b.on("click", function () {
                1 == u ? ($("html").removeClass("topbar_open"),
                    b.removeClass("toggled"),
                    u = 0) : ($("html").addClass("topbar_open"),
                        b.addClass("toggled"),
                        u = 1)
            }),
                t = !0
        ...
        if (!c) {
            var v = $(".btn-minimize");
            $("html").hasClass("sidebar_minimize") && (h = 1,
                v.addClass("toggled"),
                v.html('<i class="k-icon k-i-more-vertical ficonm"></i>')),
                v.on("click", function () {
                    1 == h ? ($("html").removeClass("sidebar_minimize"),
                        v.removeClass("toggled"),
                        v.html('<i class="k-icon k-i-menu ficonm"></i>'),
                        h = 0) : ($("html").addClass("sidebar_minimize"),
                            v.addClass("toggled"),
                            v.html('<i class="k-icon k-i-more-vertical ficonm"></i>'),
                            h = 1),
                    $(window).resize()
        ...
        if (!d) {
            ...
            f.on("click", function () {
                1 == p ? ($("html").removeClass("pagesidebar_open"),
                    f.removeClass("toggled"),
                    p = 0) : ($("html").addClass("pagesidebar_open"),
                        f.addClass("toggled"),
                        p = 1)
            }),
